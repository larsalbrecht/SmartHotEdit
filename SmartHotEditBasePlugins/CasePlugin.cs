...
namespace SmartHotEditBasePlugins
{
    ...
    public class CasePlugin : APlugin
	{
		...
		public CasePlugin(){
			this.AddFunction(new Function("CamelToKebab", "Converts a text from camelCase to kebab-case", CamelCaseToKebabCase));
			this.AddFunction(new Function("CamelToSnake", "Converts a text from camelCase to snake_case", CamelCaseToSnakeCase));
			
			this.AddFunction(new Function("KebabToCamel", "Converts a text from kebab-case to camelCase", KebabCaseToCamelCase));
			this.AddFunction(new Function("KebabToSnake", "Converts a text from kebab-case to snake_case", KebabCaseToSnakeCase));
			
			this.AddFunction(new Function("SnakeToCamel", "Converts a text from snake_case to camelCase", SnakeCaseToCamelCase));
			this.AddFunction(new Function("SnakeToKebab", "Converts a text from snake_case to kebab-case", SnakeCaseToKebaCase));
